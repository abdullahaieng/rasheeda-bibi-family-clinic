...
import "./styles.css";
import { clinicImages } from "./cloudinary";
...
function HomePage() {
  ...
  return (
    <main
      ...
      style={{ "--hero-image": `url("${clinicImages.background}")` }}
    >
      <div
    ...
    <footer className="site-footer">
      <div className="footer-brand">
        <div className="footer-mark">
          <img src={clinicImages.logo} alt="Rasheeda Bibi Family Care Clinic logo" />
        </div>
